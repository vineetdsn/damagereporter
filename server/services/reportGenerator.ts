  ...
  async generatePDF(report: Report): Promise<Buffer> {
    return new Promise((resolve, reject) => {
      try {
        ...
        doc.text('🛡️ This report is digitally verified and timestamped', 50, y);
...
<body>
    ...
    <div class="section">
        <h3 class="section-title">⚠️ Incident Details</h3>
        <div class="info-grid">
            <div class="info-item">
    ...
    <div class="section">
        <h3 class="section-title">📷 Damage Documentation</h3>
    ...
    <div class="footer">
        <div style="display: flex; justify-content: space-between;">
            <div>🛡️ This report is digitally verified and timestamped</div>
